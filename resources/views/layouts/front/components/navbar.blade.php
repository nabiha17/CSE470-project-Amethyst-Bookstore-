...
{{--                        <span>+88-{{$settings->bkash_num}}</span>--}}
                        <span>+880 1792 594 554</span>
                    </li>
                    {{--<li>--}}
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-3">
                <a style="margin: 0px 37px;" class="btn btn-outline-success" href="{{route('welcome')}}">Amethyst Bookstore</a>
            </div>
